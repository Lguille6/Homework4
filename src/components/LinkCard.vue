...
<template>
  ...
  >
    ...
    <div class="min-w-0 flex-1">
      <h3 class="truncate font-display font-semibold text-pink-800">{{ title }}</h3>
      <p class="truncate text-sm text-pink-600">
        {{ description }}
      </p>
    </div>
